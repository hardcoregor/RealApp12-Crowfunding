...
const daysLeft = (deadline) => {
  const deadlineNumber = Number(deadline.toString());
  const difference = new Date(deadlineNumber).getTime() - Date.now();
        ...
        <div className='grid gap-5 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full'>
          {allCampaign?.map((campaign, i) => (
            <div
              ...
              >
                <img
                  src='https://images.pexels.com/photos/932638/pexels-photo-932638.jpeg?auto=compress&amp;cs=tinysrgb&amp;drp=3&amp;h=750&amp;w=1260'
